 ...
 * the given value
 */
function placeRandomly(game, value) {
...
function findIndex(array, peredicate) {
...
function init(width, height = width) {
    // Make a new game
    game = {
        board: [],
        length: 1,
...
function advance(game, direction) {
...
function advanceDisplay(direction) {
    advance(game, direction);
    render(game);
}
function initDisplay(width, height = width) {
    boardEl.innerHTML = '';
